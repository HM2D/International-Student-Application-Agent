...
<div class="wrapper row3">
    <div class="rnd">
        <div id="container" class="clear">
            <!-- ####################################################################################################### -->
            <br><br><br><br>
                <div style="border: solid #535b60 2px; border-radius: 20px; width: 500px; height: 350px; float: right; margin-right: 200px; ">


<br>
<br><br><br>

                    <font style="float: left; margin-left: 200px; margin-top: 20px;" ><?php echo $fullName ?></font>  <font  style="float: right; margin-right: 20px; margin-top: 20px; font-size: large;"         >  دانشجو:</font>
                    <br><br>



                    <font style="float: left; margin-left: 220px; margin-top: 20px;" ><?php echo $rate ?></font>  <font  style="float: right; margin-right: 20px; margin-top: 20px; font-size: large;">   رتبه: </font>


                    <font style="float: left; margin-left: 220px; margin-top: 20px;" ><?php echo $kol ?></font>  <font  style="float: right; margin-right: 20px; margin-top: 20px; font-size: large;">   کل دانشجویان: </font>


                    <div style="float: right; margin-right: 180px; margin-top: 40px;"><form method="post"><button type="submit" name="eteraz" >اعتراض</button> </form></div>



                    <div style="float: right; margin-right: 40px; margin-top: 40px;"><form method="post"><button type="submit" name="pEteraz" >پیگیری اعتراض </button> </form></div>
