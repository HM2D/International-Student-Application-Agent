            ...
            <div class="container" style="float:right; margin-right:180px;">
                <div class="row">
                    <div class="col-md-4 col-md-offset-7">
                        <h1 color="black" style="margin-left: -200px; float: left;"><?php   echo $fmsg   ?> </h1><br><br>

                        <div class="col-md-6" style="width: 500px; height: 200px; margin-left: -60px;">
                            <div class="panel panel-default">
                                <div class="panel-heading"><font align="center" style="float:right; margin-right: 160px; ">گزارشات
                                    </font><br>
                                </div>
                                ...
                                <form method="post">
                                    <div class="panel-body" style="width: 470px;">
                                        ...
                                        <button type="submit" name="go" style="float: right;  margin-right: 200px;">نمایش</button>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="width: 500px; height: 200px; margin-left: -60px; margin-top:-30px;">
                            <div class="panel panel-default">
                                <div class="panel-heading"><font align="center" style="float:right; margin-right: 160px; ">نتایج</font><br>
                                </div>
                                ...
                                <div class="panel-body" style="width: 470px;">
                                    ...
                                    <button type="submit" name="go3"  value="" style="float: right;  margin-right: 200px;">نمایش</button>
                                </div>
                            </div>
                        </div>
