    ...
    <div class="rnd">
        <div id="container" class="clear">
            ...
            <form method="post">
               ...
               <button style="float: left; margin-left: 250px;" type="submit" name="list" >نمایش اعضا</button>
                <button type="submit" style="float: right; margin-right: 300px;" name="new">اعضا جدید</button>
