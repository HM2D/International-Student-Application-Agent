...
<div class="wrapper row3">
    <div class="rnd">
        <div id="container" class="clear">
            ...
            <div style="border: solid #555555 2px; border-radius: 20px ; width: 600px; height: 200px; float: right; margin-right: 180px; margin-top: 100px; ">


                <span style="float: right; margin-right: 120px; margin-top: 80px;">  <font style="font-size:medium"  >  اعتراض شما بررسی خواهد شد . بعد از ۲۴ ساعت مراجعه کنید.  </font></span>
