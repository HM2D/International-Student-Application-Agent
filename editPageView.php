        ...
        <div id="container" class="clear">
            ...
            <div id="mozh"><font size="3">
                    ...
                    <form method="post">
                        ...
                        <br>
                        <div class="form-group">
                            <label for="register-username"><i class="icon-user"></i> <b>رشته:</b></label>&nbsp;&nbsp;<?php echo $majorString ?>
                        </div>
            ...
            <div style="float:right; margin-right:30px; width:400px; height:500px; margin-top:-70px">
                <table style="width:400px;" cellspacing="2px;" cellpadding="2px;">
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="associateUni" value="<?php echo $associateUni ?>"></td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="associateAverage" value="<?php echo $associateAverage ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="bachelorUni" value="<?php echo $bachelorUni ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="bachelorAverage" value="<?php echo $bachelorAverage ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td> <input name="thesis" value="<?php echo $thesis ?>"></td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td> <input name="conferance" value="<?php echo $conferance ?>"></td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="experience" value="<?php echo $experience ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="bachelorDegree" value="<?php echo $bachelorDegree ?>"></td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="associateDegree" value="<?php echo $associateDegree ?>"></td>
                        <td data-field="price">3 , 2 , 1</td>
                    ...
                    <tr align="center" style="text-align:center;" >
                        ...
                        <td><input name="article1" value="<?php echo $article ?>"></td>
                        <td data-field="price">5</td>
                    ...
                    <tr align="center" style="text-align:center;" >
                        ...
                        <td><input name="article2" value="<?php echo $article2 ?>"></td>
                        <td data-field="price">5</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="festival" value="<?php echo $festival ?>"></td>
                        <td data-field="price">3</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="project" value="<?php echo $project ?>"></td>
                        <td data-field="price">4</td>

                    </tr>
                    <tr align="center" style="text-align:center;">
                        <td data-field="id">مدرک زبان </td>
                        <td><input name="degreeLanguage" value="<?php echo $degreeLanguage ?>"></td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="olympiad" value="<?php echo $olympiad ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="invention" value="<?php echo $invention ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="bookWritten" value="<?php echo $bookWritten ?>"></td>
                        <td data-field="price">5</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="translation" value="<?php echo $translation ?>"</td>
                        <td data-field="price">3</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="other" value="<?php echo $other ?>"></td>
                        <td data-field="price">1</td>
            ...
            <div style="float:right; width:300px; height:70px; margin-right:550px; margin-top:-220px; ">
                <table style="width:300px;" cellspacing="2px;" cellpadding="2px;">
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="information" value="<?php echo $information ?>"</td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="shiveRaftar" value="<?php echo $behavior ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="estedlal" value="<?php echo $thought ?>"></td>
                        <td data-field="price">2</td>
                    ...
                    <tr align="center" style="text-align:center;">
                        ...
                        <td><input name="bayan" value="<?php echo $speech ?>" ></td>
                        <td data-field="price">2</td>
            ...
            <button type="submit" name="edit" style="float: right; margin-right: 370px; margin-top: 50px;">ثبت</button>
            <button type="submit" name="noEdit" style="float: right; margin-right: 170px; margin-top: 50px;">بی پاسخ</button>
            <button type="submit" name="documents" style="float: right; margin-right: 70px; margin-top: 50px;">دیدن مدارک</button>
