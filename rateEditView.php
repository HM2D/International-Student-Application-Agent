...
<head>
    <div style="float:left; margin-left:270px; margin-top:10px;"><img width="70px" height="70px" style="border:1px solid black;border-radius: 25%;" src="2.jpg" /></div>
...
<div style="float:right; margin-right:30px; width:400px; height:500px; margin-top:-70px">
    <table style="width:400px;" cellspacing="2px;" cellpadding="2px;">
        ...
        <tr align="center" style="text-align:center;" >
            ...
            <td><input name="article1" value="<?php echo $article1 ?>"></td>
            <td data-field="price">5</td>
        ...
        <tr align="center" style="text-align:center;">
            ...
            <td><input name="translation" <?php echo $translation ?>></td>
            <td data-field="price">3</td>
...
<div style="float:right; width:300px; height:70px; margin-right:550px; margin-top:-220px; ">
    <table style="width:300px;" cellspacing="2px;" cellpadding="2px;">
        ...
        <tr align="center" style="text-align:center;">
            ...
            <td><input name="shiveRaftar" value="<?php echo $behaviour ?>"></td>
            <td data-field="price">2</td>
        ...
        <tr align="center" style="text-align:center;">
            ...
            <td><input name="bayan" value="<?php echo $bayan ?>" ></td>
            <td data-field="price">2</td>
...
<button type="submit" name="edit" style="float: right; margin-right: 470px; margin-top: 50px;">ثبت</button>
