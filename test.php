...
<div class="wrapper row3">
    <div class="rnd">
        <div id="container" class="clear">
            ...
            <select name="ostadSelect" > <?php echo $ostadString ?></select>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                    <tr>
                                        <th><font color="#000000">تاریخ مصاحبه</font></th>

                                        <th><font color="#000000">کد استاد</font></th>

                                        <th><font color="#000000">اسامی</font></th>

                                        <th><font color="#000000">رشته</font></th>

                                        <th><font color="#000000">تلفن</font></th>
